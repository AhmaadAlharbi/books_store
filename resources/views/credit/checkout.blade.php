...
<div class="container">
    <div class="row justify-content-center">
        <div id="success" style="display:none" class="col-md-8 text-center h-3 p-4 bg-success text-light rounded"> تمت
            عملية
            الشراء بنجاح</div>
        <div class="col-md-8">
            <div class="card">
    ...
    $('.card-form').on('submit', function (e) {
        ...
        stripe.confirmCardSetup(
            ...
            if (result.error) {
                ...
                toastr.error('المعلومات التي ادخلتها تحتوي على اخطاء يرجى المحاولة مرة اخرى');
